...
object GetRepositoryFakeDataFromStringJsonFile {
    fun getOneMarvelCharacterList(): DataCharacterListDTO {
        var jsonConverter = JSONConverter<DataCharacterListDTO>()
        return jsonConverter.jsonToObject(res, DataCharacterListDTO::class.java)
    }
}
